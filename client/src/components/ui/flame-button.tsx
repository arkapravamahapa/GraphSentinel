  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`flex items-center justify-center relative z-10 overflow-hidden uppercase font-bold text-xs cursor-pointer space-x-2 px-8 sm:pl-10 sm:pr-8 focus:outline-none focus-visible:outline-none focus:ring-0 focus-visible:ring-0 appearance-none ${className}`}
      >
        <div
